/*!
 * MinDB (version 0.1.11) - Database on JavaScript
 * 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mix = __webpack_require__(22);
	...
	var _zset = __webpack_require__(26);

	var _zset2 = _interopRequireDefault(_zset);

	var _mise = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (!__webpack_require__(2)()) {
		Object.defineProperty(__webpack_require__(3), 'Symbol',
			{ value: __webpack_require__(4), configurable: true, enumerable: false,
				writable: true });
	}
	...
	******************************/
	...
	min.mset = function (plainObject) {
	  ...
	  var next = function next(key, index) {
	    ...
	    _this5.set(key, plainObject[key]).then(function (_ref7) {
	...
	min.msetnx = function (plainObject) {
	  ...
	  var next = function next(key, index) {
	    ...
	    _this6.setnx(key, plainObject[key]).then(function (_ref9) {
	...
	******************************/
	...
	min.zrange = function (key, min, max) {
	  ...
	  this.exists(key).then(function (exists) {
	    ...
	    var members = _utils2.default.flatten(hashs.map(function (hash) {
